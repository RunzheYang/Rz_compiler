...
expression
    ...
    |   expression  op = MULTI_OP    expression  #MULTI
    |   expression  op = ADDITIVE_OP expression  #ADDITIVE
    |   expression  op = SHIFT_OP    expression  #SHIFT
    |   expression  op = RELATION_OP expression  #RELATION
    |   expression  op = EQUALITY_OP expression  #EQUALITY
...
postfix
//    |    '.' 'size' '(' ')'                     #Array_Build_in
//    |    '.' 'length' '(' ')'                   #String_Build_in_Length
//    |    '.' 'substring' '(' arguments? ')'     #String_Build_in_Substring
//    |    '.' 'parseInt' '(' ')'                 #String_Build_in_ParseInt
//    |    '.' 'ord'  '(' arguments? ')'          #String_Build_in_Ord
